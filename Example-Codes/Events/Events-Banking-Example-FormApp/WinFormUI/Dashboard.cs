...
namespace WinFormUI
{
    public partial class Dashboard : Form
    {
        ...
        {
            customer.CustomerName = "Atakan";
            customer.CheckingAccount = new Account();
            customer.SavingsAccount = new Account();

            customer.CheckingAccount.AccountName = "Atakan Checking Account";
            customer.SavingsAccount.AccountName = "Atakan Savings Account";

            customer.CheckingAccount.AddDeposit("Initial Balance", 150.00M);
            customer.SavingsAccount.AddDeposit("Initial Balance", 100.00M);
        }
        ...
        private void WireUpForm()
        {
            ...
            // loading events action
            // this is "listen" part of events
        ...
        {
            errorMessage.Text = $"Overdraft amount : {string.Format("{0:C2}", e)}";
