...
namespace DemoLibrary
{
    public class Account
    {
        ...
        // Events work between three point: 1)triger 2)listen and 3)event-handler(between listen and triger)
        ...
        public bool AddDeposit(string depositName, decimal amount)
        {
            ...
            Balance += amount;
            // Invoke is triger part of events.
            // "this" is data about who invoke the event.
            // "?" check if RaiseTransactionApprovedEvent is null or not. If it is null than it wont invoke
            TransactionApprovedEvent?.Invoke(this,depositName);
            return true;
        }
        // Default value of backupAccount is null. If we pass paramater there, it will not be null.
